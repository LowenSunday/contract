...
public class IdentifyingCode 
{
    ...
    public String drawRandomString(int length , Graphics2D g){  
        ...
        for(int i=0 ; i<length ; i++){  
            ...
            case 2:  //生成a-z的字母
                ...
                temp = String.valueOf((char)itmp);
            case 3:
                itmp = random.nextInt(5) + 60 ;  //0-4 + 60
                temp = String.valueOf((char)itmp);
                /*
                 * 区位码是与汉字一一对应的编码，用四位数字表示， 前两位从01 到94称区码，
                 * 后两位从01到94称位码。 一个汉字的前一半是 ASCⅡ码为“160＋区码”的字符，
                 * 后一半是ASCⅡ码为“160＋ 位码”的字符。
                 * 一级汉字:16区到55区,0-89位。
                 */ 
             /*  
            case 3:     //生成汉字  
                ...
                System.out.println("strR12 ="+strR12);
                int tempLow = Integer.parseInt(strR12, 16) ;
                System.out.println(" tempLow= "+tempLow);  
                bytes[0] = (byte)tempLow;  
                String strR34 = strR3 + strR4 ;     //将生成的区码保存到字节数组的第2个元素中  
                System.out.println("strR34 ="+strR34);
                int tempHigh = Integer.parseInt(strR34, 16) ;  
                System.out.println(" tempHigh= "+tempHigh); 
    ...
    public static void main(String args[])throws Exception
    {
    	...
    	System.out.println(new String(ic.drawRandomString(4, g).getBytes(),"gb2312"));
